...
describe('Course page model tests', () => {
	...
	let courseRecordClientStub: sinon.SinonStubbedInstance<typeof courseRecordClient>
	...
	beforeEach(() => {
		...
		courseRecordClientStub = sandbox.stub(courseRecordClient)
		courseRecordClientStub.getCourseRecord.resolves(undefined)
