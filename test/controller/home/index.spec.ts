	...
	describe('Learning plan', () => {
		...
		it('should render the correct messaging when there is no learning plan', async () => {
			...
			expect(res.text).to.contain(
				'<p class="govuk-body">You can add learning by checking <a href="/courseCatalogue-for-you">Suggestions for you</a> or <a href="/search?q=">searching for a specific course</a>.</p>'
			)
		})
